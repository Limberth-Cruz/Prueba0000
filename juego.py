...
# hambre
# arrepentimiento
class HijoProdigo : #clase
    def __init__(self, nombre):  #Este es el CONSTRUCTOR // Sirve para inicializar los atributos
        self.nombre =  nombre
        self.dinero = 100 #ATRIBUTOS
        self.dignidad = 50 #ATRIBUTOS
        self.hambre = 0 #ATRIBUTOS
        self.arrepentimiento =0 #ATRIBUTOS
# gastar_todo()
# invertir()
# ahorrar()
# trabajar()
# reflexionar()
    def gastar_todo(self): #Método gastar todo()
        self.dinero = 0 
        self.dignidad -=20 
        self.hambre += 50 
        
    def invertir(self): #Método invertir()
        self.dinero += 20
        print(f"has invertido sabiamente tu dinero : {self.dinero}")      
        
    def ahorrar(self): #Método ahorrar()
        self.dinero += 20
        
    def trabajar(self): #Método trabajar()
        self.dinero += 15
    
    def reflexionar(self): #Método reflexionar()
        if self.hambre > 40:
            self.arrepentimiento += 10 #ATRIBUTOS

jugador =  HijoProdigo(input("Ingrese su nombre: "))      #guardar lo que se escribe // crear un objeto de la clase HijoProdigo
...
while jugador.dinero > 0: #Se repite mientras el dinero sea mayor que 0
    print("“Sigues viviendo lejos de casa…”")
    # jugador.dinero -= 10  
    jugador.gastar_todo() #Uso del OBJETO
    jugador.reflexionar() #Uso del OBJETO
